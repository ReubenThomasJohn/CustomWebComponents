...
<style>
    ...
    <div class="recommendation">
      ...
      <div class="recommendation__items" id="recommendation__items">
        <div class="card" style="width: 18rem;">
        <img class="card-img-top" src="https://randomuser.me/api/portraits/men/13.jpg" alt="Card image cap">
          <div class="card-body">
            <h5 class="card-title">Cascadia ABC123</h5>
            <table class="table">
              <thead>
                <tr>
                  <th scope="col">Parameter</th>
            ...
            <a href="#" class="btn btn-primary">Purchase Link</a>
          </div>
        </div>
      </div>
      ...
      <div class="recommendation__items" id="recommendation__items">
        <div class="card" style="width: 18rem;">
        <img class="card-img-top" src="https://randomuser.me/api/portraits/men/12.jpg" alt="Card image cap">
          <div class="card-body">
            <h5 class="card-title">Cascadia ABC123</h5>
            <table class="table">
              <thead>
